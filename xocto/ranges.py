...
def iterate_over_months(
    ...
    Datetimes will be aligned to midnight as at the supplied timezone.
    """
    start_at = localtime.midnight(period.start, tz=tz)
    end_at = localtime.midnight(period.end, tz=tz)
